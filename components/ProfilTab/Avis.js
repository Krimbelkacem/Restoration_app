...
export default function Avis({ idR, idU }) {
  ...
  const addCommentToRestaurant = async () => {
    ...
    try {
      ...
      // Handle any further logic or state updates
    } catch (error) {
  ...
  const [data, setData] = React.useState([
    {
      ...
      text:
        "Tech founder and philanthropist @BillGates spoke in conversation with Executive Director @mfullilove at 31 Bligh Street. They discussed global challenges in climate, environment, pandemic preparedness and public health. Watch or listen: ",
      like: 125,
      comment: 8,
    },
    {
