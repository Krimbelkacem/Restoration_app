...
const SignUpScreen = ({navigation}) => {
    ...
    return (
      ...
      />
            ...
            <TouchableOpacity   onPress={submit} style={{ backgroundColor: 'black', width: 350, borderRadius: 10, marginTop: 20, paddingVertical: 15 }}>
                <Text style={{  fontSize: 20, color: '#FFF', textAlign: 'center', }}>S'inscrire</Text>
            </TouchableOpacity>

            <TouchableOpacity onPress={()=> navigation.navigate('LoginScreen')}>
                <Text style={{  fontSize: 16, color: '#353045', textAlign: 'center', marginTop: 25 }}>Vous avez deja un compte</Text>
            </TouchableOpacity>
        </FadeIn>


        <FadeIn delay={800}>
            <View style={{ flexDirection: 'row', width: 350, justifyContent: 'space-evenly', marginTop: 20 }}>
