...
const WelcomeScreen = ({ navigation }) => {
    ...
    return (
        ...
        <View style={{ flex: 1, padding: 20,  backgroundColor: "white", alignItems: 'center' }}>
            ...
            <FadeIn delay={300}>
                <Image source={require('../../assets/01.jpg')} style={{ width: 380, height: 400, backgroundColor: '#d99bf1', borderRadius: 25 }} resizeMode='contain' />
            </FadeIn>

            <FadeIn delay={500}>
                <View style={{ marginTop: 40 }}>
                <Text style={{  fontSize: 14, color: '#353045', textAlign: 'center', marginTop: 20 }}>Bienvenu a El Mida </Text>
                <TouchableOpacity
            ...
            <FadeIn delay={800}>
                <View style={{ flexDirection: 'row', marginTop: 60, backgroundColor: '#e9ecf7', borderRadius: 10, borderWidth: 1, borderColor: '#FFF' }}>
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={{  fontSize: 16, color: '#353045' }}>Se Connecter</Text>
                    </TouchableOpacity>
                </View>
            </FadeIn>
        </View>
